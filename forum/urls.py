...
urlpatterns = [
     ...
     path('discussion/<param_discussion>', views.discussion_view, name='param_discussion'),
     ...
     path('discussion/<param_discussion>/delete', views.discussion_delete, name='discussion_delete'),
]
